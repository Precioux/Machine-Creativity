...
GEMMA_FOLDER   = Path("/Users/precioux/Desktop/Creativity/code/gemma")  # keep same folder if you want
...
MODEL_TAG     = os.environ.get("GEMMA_TAG", "gemma3:latest")   # e.g., "gemma3:2b"
TEMPERATURE   = 0.0
TIMEOUT_SEC   = 60
...
def main():
    ...
    # 3) COMPARISON — Load results into DataFrame (include any previous runs)
    rows = []
